...
@deeplint/cli/0.8.1 darwin-x64 node-v12.13.1
...
_See code: [src/commands/check.ts](https://github.com/deeplint/deeplint/blob/v0.8.1/src/commands/check.ts)_
...
_See code: [src/commands/fix.ts](https://github.com/deeplint/deeplint/blob/v0.8.1/src/commands/fix.ts)_
...
_See code: [src/commands/scan.ts](https://github.com/deeplint/deeplint/blob/v0.8.1/src/commands/scan.ts)_

## `deeplint show`

Display the packs, snapshots and checking results in the human-readable format
...
_See code: [src/commands/show.ts](https://github.com/deeplint/deeplint/blob/v0.8.1/src/commands/show.ts)_
<!-- commandsstop -->
